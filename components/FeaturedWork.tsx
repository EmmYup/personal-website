...
import { ArrowRight, Flag, MessageSquare, Users } from "lucide-react";
...
const projects = [
  {
    ...
    description: "Built internal feature flag system replacing LaunchDarkly, reducing costs by 95% ($50k/year) while improving reliability and deployment speed.",
  ...
  },
  {
    ...
    company: "Vetted Health",
    description: "Designed event-driven messaging platform handling 500 qualified candidates/day with automated engagement pipelines and sentiment analysis.",
    impact: ["500 candidates/day", "150k active users", "99.9% uptime"],
    tags: ["TypeScript", "SQS", "PostgreSQL", "WebSockets"],
  },
  {
    icon: Users,
    title: "Engineering Team Leadership",
    company: "Vetted Health",
    description: "Led team of 7 engineers, improved delivery velocity by 25%, established ownership culture, and maintained zero attrition rate.",
    impact: ["7 engineers", "25% faster delivery", "Zero attrition"],
    tags: ["Leadership", "Hiring", "Mentoring", "Process"],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Recent projects demonstrating technical leadership and business impact
          </p>
        </motion.div>
