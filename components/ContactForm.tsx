      ...
      >
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted">github.com/emmanuelpyupit</p>
            </div>
          </a>
        ...
        <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-primary/5 to-accent/5 border border-border">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-success font-medium">Available for interviews</span>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="p-8 rounded-2xl border border-border bg-background">
          <p className="text-muted mb-6">
            ...
            <a href="mailto:e.pyupit@gmail.com" className="text-primary hover:underline">
              e.pyupit@gmail.com
            </a>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-border">
              ...
              <div className="flex flex-wrap gap-2">
                {["Engineering Manager", "Tech Lead", "Staff Engineer", "Founding Engineer"].map((role) => (
                  <span
                    key={role}
