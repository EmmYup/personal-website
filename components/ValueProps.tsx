...
const valueProps = [
  {
    ...
    description: "Built systems handling 500 candidates/day, 150k active users, and $20M ARR with 99.9%+ uptime",
    metrics: ["500/day", "150k users", "99.9% uptime"],
  },
  {
    icon: DollarSign,
    title: "Cost-Conscious Builder",
    description: "Replaced $50k/year vendor with internal platform, saving 95% while improving reliability",
    metrics: ["95% savings", "$50k/year", "Better reliability"],
  },
  {
    icon: Users,
    title: "Team Multiplier",
    description: "Led 7 engineers, improved delivery velocity 25%, and built ownership-driven culture",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted max-w-2xl mx-auto">
            Proven track record of building reliable systems while leading high-performing teams
          </p>
        </motion.div>
